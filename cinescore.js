...
(function () {
    ...
    function setValue($block, key, value) {
        ...
        var idx = map[key];
        if (!idx) return;
        $block.find('.cinescore__item').eq(idx - 1).find('.cinescore__value').text(value || '—');
    }
    ...
    function addSettings() {
        Lampa.SettingsApi.addComponent({
            component: NAME,
            name: 'CineScore',
            icon: '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 2L14.9 8.9L22 9.6L16.6 14.3L18.2 21.4L12 17.6L5.8 21.4L7.4 14.3L2 9.6L9.1 8.9L12 2Z" stroke="currentColor" stroke-width="1.5" stroke-linejoin="round"/></svg>'
        });
